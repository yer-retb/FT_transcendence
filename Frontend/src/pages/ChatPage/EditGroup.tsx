            ...
            >
                <div className="relative top-20 mx-auto p-5 w-[28.5vw] h-[23vw] rounded-[1.5vw] bg-slate-800">
                    <div className="flex flex-col justify-between items-center mb-6">
                        ...
                        <h2 className="text-[#9DB2BF] md:text-[1.5vw] text-[1.4vw] mb-2 text-start font-[Poppins] not-italic font-bold leading-[normal]">
                            Edit your group
                        </h2>
                    ...
                    <div className="flex flex-col items-center mb-6">
                        <input
                            ...
                            maxLength={10}
                            className='w-4/5 bg-[rgba(157,178,191,0.91)] rounded-[0.356vw] text-gray-900 md:text-[1.146vw] sm:text-[1.146vw] font-["poppins"] font-semibold pl-8 border-[#1e1e1e] py-2 mb-8 placeholder-gray-700 capitalize'
                        />
                    ...
                    <button
                        className="w-5/12 h-11 py-2 ml-[140px] flex-shrink-0 rounded-[0.356vw] bg-[rgba(157,_178,_191,_0.80)] text-gray-800 text-[1vw] text-center font-[Poppins] font-bold hover:bg-slate-950 hover:scale-110 transition duration-100 hover:text-[#9DB2BF]"
