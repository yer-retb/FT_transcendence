    ...
    return (
        <div>
            <div
                ...
                id="my-modal"
            >
                <div className="relative top-20 mx-auto p-5 w-[28.5vw] h-[27vw] rounded-[1.5vw] bg-slate-800">
                    <div className="flex flex-col justify-between items-center mb-6">
                        ...
                        <h1 className="w-[20vw] text-[#9DB2BF] md:text-[0.9vw] text-[0.9vw]  text-center font-[Poppins] not-italic font-smale leading-[normal]">
                            give your new group a personality with a name
                        </h1>
                    </div>
                    ...
                    <button
                        className="w-5/12 h-11 py-2 ml-[100px] flex-shrink-0 rounded-[0.356vw] bg-[rgba(157,_178,_191,_0.80)] text-gray-800 md:text-[0.938vw] text-[1vw] text-center font-[Poppins] font-bold hover:bg-slate-950 hover:scale-110 transition duration-100 hover:text-[#9DB2BF]"
