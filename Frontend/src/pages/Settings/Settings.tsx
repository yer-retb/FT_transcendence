        ...
        const fetchData = async () => {
            try {
                const res = await axios.get(
                    `http://localhost:3000/Users/history/${user?.login}`,
    ...
    return (
        <>
            {user?.login ? (
                ...
                <div className='w-[1210px] flex justify-center items-center'>
                    <p className="text-[#9DB2BF] text-[1.777vw] text-start font-[Poppins] not-italic font-semibold">
