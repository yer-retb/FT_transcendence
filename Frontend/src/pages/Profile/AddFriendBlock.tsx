...
function AddFriendBlock({ username }: { username: string }) {
        ...
        const relationship = async () => {
            try {
                const res = await axios.get(
                    `http://localhost:3000/Users/relations/${username}`,
                    {
    ...
    const Block = async () => {
        ...
        try {
            axios.post(`http://localhost:3000/Users/block/${user?.login}`, {
                blocked: username
            },
            {
                withCredentials: true
        ...
        try {
            axios.delete(`http://localhost:3000/Users/friends/${user?.login}`, {
                data: {
                    friend: username
                },
                withCredentials: true
    ...
    const AddFriend = async () => {
        if (user?.login === username) return;
        try {
            axios.post(`http://localhost:3000/Users/friends/${user?.login}`, {
                friend: username
            },
            {
                withCredentials: true
